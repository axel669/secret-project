...
var CDCard = (function (_React$Component) {
    ...
    function CDCard(props) {
        ...
        this.finish = function (evt) {
            var forced = arguments.length <= 1 || arguments[1] === undefined ? null : arguments[1];
        ...
        if (this.props.movable === true) {
            this.answerToken = PubSub.subscribe("campdisco.game.forceAnswer", function (t, send) {
                // console.log(t, send);
                _this.finish(null, send);
            });
        } else {
    ...
    function GameScreen(props) {
                ...
                return _regeneratorRuntime.async(function callee$3$0$(context$4$0) {
                    while (1) switch (context$4$0.prev = context$4$0.next) {
                        case 0:
                            ...
                            context$4$0.next = 5;
                            return _regeneratorRuntime.awrap(chrono.wait(600));
        ...
        this.render = function () {
            ...
            return React.createElement(
                ...
                React.createElement(
                    'div',
                    { style: { transition: 'transform 500ms ease-in', transform: 'scale(' + scale + ', ' + scale + ')', position: 'absolute', width: '100%', height: '100%', top: 0 } },
                    choices,
                    movable
                )
            );
...
var RealScreen = (function (_Subscribable3) {
    ...
    function RealScreen() {
        ...
        this.componentDidMount = function () {
            // this.token = PubSub.subscribe(
            window.nope = new Howl({ urls: ['audio/Not quite.mp3'], onend: function onend() {
                    return PubSub.publish('campdisco.response.finished');
                } });
            _this4.pubListen("campdisco.game.nextgame", function () {
